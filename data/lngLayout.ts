...
export const en:ILngLayout = [
  ...
  { kbdKey: IKbdKey.ControlLeft, symbol: "^", shift: false },
  { kbdKey: IKbdKey.AltLeft, symbol: "⌥", shift: false },
  { kbdKey: IKbdKey.MetaLeft, symbol: "⌘", shift: false },
  { kbdKey: IKbdKey.Space, symbol: "space", shift: false },
  { kbdKey: IKbdKey.AltRight, symbol: "⌥", shift: false },
  { kbdKey: IKbdKey.MetaRight, symbol: "⌘", shift: false },
